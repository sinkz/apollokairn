<div align="center">
  ...
  <p>
    ...
    <img alt="Testes de regressão: 257" src="https://img.shields.io/badge/testes-257-3b6ea8">
...
| Testes de regressão | `257` | Testes unitários e de workflow rodados antes da publicação atual. |
...
| `apollokairn usage` | Ativa métricas locais de uso e gera relatórios/evidência do vault |
