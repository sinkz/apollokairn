---
type: Decision
title: Support latency decision
description: Decision record for support latency handling.
tags: [support, support, latency, decision]
timestamp: 2026-06-19T00:00:00Z
aliases: [slow response, support severity, timeout escalation, support decision]
systems: [support, customer]
signals: [timeout, latency, escalation]
---

# Context

The support workflow reports timeout and latency behavior around escalation.
...
facts for the support latency workflow.
