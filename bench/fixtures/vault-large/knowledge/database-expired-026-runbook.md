---
type: Runbook
title: Database expired checkout runbook
description: Resolve database stale incidents for checkout.
tags: [database, database, stale]
timestamp: 2026-06-19T00:00:00Z
aliases: [invalid state, database connection, expired checkout]
