<div align="center">
  ...
  <p>
    ...
    <img alt="Regression tests: 219" src="https://img.shields.io/badge/tests-219-3b6ea8">
...
| Regression tests | `219` | Unit and workflow tests run before publishing the current page. |
