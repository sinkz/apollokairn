<div align="center">
  ...
  <p>
    ...
    <img alt="Regression tests: 221" src="https://img.shields.io/badge/tests-221-3b6ea8">
...
| Regression tests | `221` | Unit and workflow tests run before publishing the current page. |
