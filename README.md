<div align="center">
  ...
  <p>
    ...
    <img alt="Regression tests: 245" src="https://img.shields.io/badge/tests-245-3b6ea8">
...
| Regression tests | `245` | Unit and workflow tests run before publishing the current page. |
