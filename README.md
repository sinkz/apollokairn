<div align="center">
  ...
  <p>
    ...
    <img alt="Regression tests: 208" src="https://img.shields.io/badge/tests-208-3b6ea8">
...
| Regression tests | `208` | Unit and workflow tests run before publishing the current page. |
